...
# %%
CONFIG = {
    "checkpoint_dir" : "../checkpoints/PointCloudDataset_SlidingWindow_10_channel_v2",
    "num_classes"    : 2,
    "target_class"   : 1,
    "val_ratio"      : 0.15,
    "test_ratio"     : 0.15,
    ...
    "mlflow_experiment": "PT_v2_SlidingWindow_10_channel",
}
...
try:
    ...
    dagshub.init(repo_owner="darwald2024",repo_name="ojdo",mlflow=True)
    MLFLOW_OK = True
